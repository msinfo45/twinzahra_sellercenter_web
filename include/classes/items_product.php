...
require_once "../../config/config_type.php";
       ...
       if (isset($_POST['Search'])) {
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, $BASE_URL.'/api/products.php?request=get_products');
			...
			foreach($result['data'] as $DataProduct)
			{
              ...
              //  echo '</div>';
                ...
                echo '<div id="variant'.$DataProduct['ProductID'].'" class="collapse">';
                 ...
                 $ch = curl_init();
                curl_setopt($ch, CURLOPT_URL, $BASE_URL.'/api/products.php?request=get_product_item');
