                        ...
                        <div class="app-page-title">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-numbers text-white"><span><?php echo count($resultOrders["data"]);?></span></div>
                                        </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Siap Kirim</div>
                                         <div class="widget-subheading">
                                          <div class="widget-numbers text-white"><span><?php echo count($resultRts["data"]);?></span></div>
                                        </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Keuntungan Kotor</div>
                                     <div class="widget-subheading">
                                          <div class="widget-numbers text-white"><span>
										  <?php 
										  
										   foreach($resultOrders['data'] as $price) {
