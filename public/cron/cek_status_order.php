        ...
        foreach ($jdecode->data as $datas) {
          ...
          foreach ($datas -> order_items as $order_items) {
            ...
            if ($status == "shipped") {
              ...
              $ch = curl_init();
              curl_setopt($ch, CURLOPT_URL, 'https://twinzahra.masuk.id/public/api/orders.php?request=set_ship');
...
<table width="600" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" align="center">
                                    ...
                                    <td>
                                       <table style="table-layout:fixed" width="560" cellspacing="0" cellpadding="0" border="0" align="center">
                                          <tbody>
                                             ...
                                             <tr>
                                                <td colspan="2" style="text-align:left;font-family:Helveticƒa,arial,sans-serif;color:#1f1f1f;font-size:13px;font-weight:bold">DETAIL ORDER </td>
                                             </tr>
                                             <tr>
                                                <td style="font-size:1px;line-height:1px" width="" height="10">&nbsp;</td>
                                             </tr>
                                             <tr>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;white-space:nowrap;vertical-align:top" width="280">No. Order: </td>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top">'. $order_id .'</td>
                                             </tr>
                                             <tr>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;white-space:nowrap;vertical-align:top" width="280">Tanggal Order: </td>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;white-space:nowrap;vertical-align:top" width="280">'. $created_at  .'</td>
                                             </tr>
                                             <tr>
                                                <td style="font-size:1px;line-height:1px" width="100%" height="10">&nbsp;</td>
                                             </tr>
                                 ...
                                 <tr>
                                    <td>
                                       ...
                                       <table style="table-layout:fixed" width="560" cellspacing="0" cellpadding="0" border="0" align="center">
                                          <tbody>
                                             <tr>
                                                <td colspan="2" style="word-break:break-word;font-size:1px;line-height:1px" width="" height="20">&nbsp;</td>
                                             </tr>
                                             <tr>
                                                <td colspan="2" style="word-break:break-word;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;text-align:left">'. $name.'
                                                </td>
                                             </tr>
                                             <tr>
                                                <td colspan="2" style="word-break:break-word;font-size:1px;line-height:1px" width="" height="15">&nbsp;</td>
                                             </tr>
											 <tr>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">Sku: </td>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">'. $sku .'</td>
                                             </tr>
											 
											 <tr>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">Variasi: </td>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">'. $variation .'</td>
                                             </tr>
                                             <tr>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">Jumlah: </td>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">1</td>
                                             </tr>
                                             <tr>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">Harga: </td>
                                                <td style="word-break:break-word;text-align:left;font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;vertical-align:top" width="280">Rp. '. $paid_price .'</td>
                                             </tr>
                                             <tr>
                                                <td colspan="2" style="font-size:1px;line-height:1px" width="" height="10">&nbsp;</td>
                                             </tr>
                                          </tbody>
                                       </table>
                                    </td>
   ...
   <div class="adL">
              ...
              $ch = curl_init();
              curl_setopt($ch, CURLOPT_URL, 'https://twinzahra.masuk.id/public/api/orders.php?request=set_delivery');
              $payload = json_encode( array( "order_id"=> $order_id ,
                "created_at"=> $created_at,
                "name"=> $name,
                "sku"=> $sku,
              ...
              $subject  = "Pesanan " . $order_id . " telah diterima pembeli" ;
              $message = '
                                    ...
                                    <td>
                                       <table width="560" cellspacing="0" cellpadding="0" border="0" align="center">
                                          <tbody>
                                             ...
                                             <tr>
                                                <td style="font-family:Helvetica,arial,sans-serif;font-size:13px;color:#000000;text-align:left;line-height:18px">
										Pesanan ' . $order_id . ' telah diterima pembeli
                                                </td>
                                             </tr>
                                             <tr>
                                                <td style="font-size:1px;line-height:1px" width="100%" height="10">&nbsp;</td>
